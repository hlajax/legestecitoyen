...
class PetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create petition" do
    assert_difference('Petition.count') do
      post petitions_url, params: { petition: { citoyen_id: @petition.citoyen_id, contenu: @petition.contenu, image: @petition.image, petition_cat_id: @petition.petition_cat_id, titre: @petition.titre } }
    end
  ...
  test "should update petition" do
    patch petition_url(@petition), params: { petition: { citoyen_id: @petition.citoyen_id, contenu: @petition.contenu, image: @petition.image, petition_cat_id: @petition.petition_cat_id, titre: @petition.titre } }
