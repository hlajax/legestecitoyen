...
class MagazinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post magazines_url, params: { magazine: { administrateur_id: @magazine.administrateur_id, cover: @magazine.cover, description: @magazine.description, lien: @magazine.lien, titre: @magazine.titre } }
    end
  ...
  test "should update magazine" do
    patch magazine_url(@magazine), params: { magazine: { administrateur_id: @magazine.administrateur_id, cover: @magazine.cover, description: @magazine.description, lien: @magazine.lien, titre: @magazine.titre } }
